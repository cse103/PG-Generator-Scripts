...
\voffset=-0.8in
\newpage
{\textbf \Large Final Exam, version 3} \hfill CSE 103, Fall 2013
\\
...
Suppose that the probability she uses the cross-walk is 90\%. Furthermore, suppose that the probability of getting hit by a car is $10^{-6}$ when using the cross-walk and $10^{-2}$ when not using the cross-walk. 
\vskip\baselineskip
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
You are giving candy to 3 kids. The candy consists of 7 Twix and 7 Milky-ways. Each kids gets at least one Twix. How many ways are there to distribute the candy among the kids?
\vskip\baselineskip
\mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pgmlItem{}$P(X=1|Y=1) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
Marginal over X & 3/8  & 1/4  & 3/8  &* \\ \hline 
...
Y=1 & 1/10 &1/5 &1/5 &1/2 \\ \hline 

Y=2 &   &1/10 & &1/4 \\ \hline 

Y=3 &1/20 & 1/10 &   & 1/4  \\ \hline 
...
\pgmlItem{}$P(X=3|Y=1) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
You are given a card deck of 50 cards, consisting all combinations of 10 ranks and 5 suits. Suppose you draw a hand of 5 cards out of this deck, what is the probability that it will be a {\itshape{}straight} ?
\vskip\baselineskip
Recall that a {\itshape{}straight} refers to five cards whose ranks are in sequence, but whose suits are {\bfseries{}not all the same} (otherwise it is called a straight flush). The 1 can be used either as a low card or a high card when forming a straight. For example, both (1,2,3,4,5) and (7,8,9,10,1) are valid straight ranks, but not (8,9,10,1,2).
\vskip\baselineskip
...
\pgmlItem{}Write an exact expression for the probability that the number of heads is equal to 0.7$\times$100=70.  \mbox{  \parbox[t]{20ex}{\hrulefill}  }


\pgmlItem{}What Z-score corresponds to getting 70 heads? \mbox{  \parbox[t]{20ex}{\hrulefill}  }


\pgmlItem{}What is the central limit theorem approximation for the probability that the number of heads is 70 or higher assuming that the coin is fair? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}What Z-score corresponds to getting 0.7$\times$10000=7000 heads? \mbox{  \parbox[t]{20ex}{\hrulefill}  }


\pgmlItem{}What is the central limit theorem approximation for the probability that the number of heads is 7000 or higher assuming that the coin is fair?\mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
...
\pgmlItem{}As we increase the number of coin flips $n$, does the probability of the event {\bfseries{}``the number of heads is larger than 0.7$\times n$''} increase,decrease or stay the same? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
...
\pgmlItem{}What is the probability that it will not receive any request within the first 5 seconds of some particular minute? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip


\pgmlItem{}What is the probability that it will receive exactly 4 requests during the same period of time? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip


\pgmlItem{}What is the probability that the time between the first and the second requests received in a minute would be smaller than 4 seconds?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
Suppose $X_1, ... , X_{66}$ are independent random variables where $X_i \in \{0,1\}$ and $P(X_i = 1) = 0.2$ for $i = 1, ..., n$.
\vskip\baselineskip
Define a random variable $Y = \sum_{i=1}^{66}{(-1)^{i+1} X_i} = X_1 - X_2 + X_3 - X_4 + ... - X_{66}$
\vskip\baselineskip
What is $E[Y]$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
What is $Var[Y]$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
Using Chebyshev's inequality, give un upper bound on $P(|Y| > 30)$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
