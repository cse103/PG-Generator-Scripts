...
\pgmlItem{}$P(Y=3|X=2) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}$P(Y=2|X=2) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\par}%
\leavevmode\\\relax 
\includegraphics[width=0.8\linewidth]{imgs/mixture_cdf_4.png}
