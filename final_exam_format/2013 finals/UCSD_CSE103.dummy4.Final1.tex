...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}$P(X=1|Y=3) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
\pgmlRule{100\pgmlPercent}{1\pgmlPixels}%
...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}$P(Y=1|X=1) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
\pgmlRule{100\pgmlPercent}{1\pgmlPixels}%
...
\vskip\baselineskip
\pgmlItem{}What is the probability that the time between the first and the second requests received in a minute would be smaller than 2 seconds?  \mbox{\parbox[t]{7ex}{\hrulefill}}
...
\vskip\baselineskip
Using Chebyshev's inequality, give un upper bound on $P(|Y| > 20)$?  \mbox{\parbox[t]{14ex}{\hrulefill}}
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
