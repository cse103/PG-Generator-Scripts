...
\vskip\baselineskip
Using Chebyshev's inequality, give un upper bound on $P(|Y| > 29)$?  \mbox{\parbox[t]{14ex}{\hrulefill}}
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\par}%
\leavevmode\\\relax 
\includegraphics[width=0.8\linewidth]{/opt/webwork/courses/UCSD_CSE103/templates/setFinals/mixture_cdf_0.png}
