...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}$P(X=2|Y=2) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}$P(X=3|Y=3) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
\pgmlRule{100\pgmlPercent}{1\pgmlPixels}%
...
\vskip\baselineskip
\pgmlItem{}What is the probability that it will receive exactly 1 requests during the same period of time? \mbox{\parbox[t]{11ex}{\hrulefill}}
\vskip\baselineskip
\pgmlItem{}What is the probability that the time between the first and the second requests received in a minute would be smaller than 1 seconds?  \mbox{\parbox[t]{7ex}{\hrulefill}}
...
\par}%
\leavevmode\\\relax 
\includegraphics[width=0.8\linewidth]{/opt/webwork/courses/UCSD_CSE103/templates/setFinals/mixture_cdf_3.png}
