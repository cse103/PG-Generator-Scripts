...
\voffset=-0.8in
\newpage
{\textbf \Large Final Exam, version 4} \hfill CSE 103, Fall 2013
\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
How many strings of 4 lower case letters are there that contain at least 2 of the letters in the range a-g inclusive?
\vskip\baselineskip
...
Suppose that the probability she uses the cross-walk is 90\%. Furthermore, suppose that the probability of getting hit by a car is $10^{-9}$ when using the cross-walk and $10^{-4}$ when not using the cross-walk. 
\vskip\baselineskip
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
You are giving candy to 4 kids. The candy consists of 9 Twix and 10 Milky-ways. Each kids gets at least one Twix. How many ways are there to distribute the candy among the kids?
\vskip\baselineskip
\mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pgmlItem{}$P(X=1|Y=3) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}$P(Y=1|X=1) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
You are given a card deck of 90 cards, consisting all combinations of 15 ranks and 6 suits. Suppose you draw a hand of 5 cards out of this deck, what is the probability that it will be a {\itshape{}straight} ?
\vskip\baselineskip
...
\pgmlItem{}What is the probability that the time between the first and the second requests received in a minute would be smaller than 2 seconds?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\pgmlSetup
Suppose $X_1, ... , X_{74}$ are independent random variables where $X_i \in \{0,1\}$ and $P(X_i = 1) = 0.3$ for $i = 1, ..., n$.
\vskip\baselineskip
Define a random variable $Y = \sum_{i=1}^{74}{(-1)^{i+1} X_i} = X_1 - X_2 + X_3 - X_4 + ... - X_{74}$
\vskip\baselineskip
What is $E[Y]$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
What is $Var[Y]$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
Using Chebyshev's inequality, give un upper bound on $P(|Y| > 20)$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
