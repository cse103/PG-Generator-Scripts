...
\item\begin{verbatim}0.32/1-e^{-0.5*1.5}\end{verbatim}
\item\begin{verbatim}1-0.32/1-e^{-0.5*1.5}\end{verbatim}
...
\item\begin{verbatim}(98-38)^2/(12*48)\end{verbatim}
\item\begin{verbatim}Q((90-(38+98)/2)/(sqrt{(98-38)^2/(12*48)}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
