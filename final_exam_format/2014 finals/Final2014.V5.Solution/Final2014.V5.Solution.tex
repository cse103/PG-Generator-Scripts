...
\pgmlItem{}(1pt)$P(X=2|Y=2) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}(1pt)$P(Y=2|X=3) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}(1pt)$P(X=3|Y=3) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}(3 pts) Using Q function in your answer, what is the approximate probability of $P(S > 88)$\mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\item\begin{verbatim}(96-18)^2/(12*34)\end{verbatim}
\item\begin{verbatim}Q((88-(18+96)/2)/(sqrt{(96-18)^2/(12*34)}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
(3 pts) What is the probability that the time gap between two packets is larger than 0.03? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
...
\vspace{-\parskip}\begin{itemize}
\item  $100$
\item  $1-\sum_{i=0}^{200} \frac{100^i}{i!} e^{-100}$
\item  $3600*(1-\sum_{i=0}^{200} \frac{100^i}{i!} e^{-100})$
\item  $e^{-100*0.03}$
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
