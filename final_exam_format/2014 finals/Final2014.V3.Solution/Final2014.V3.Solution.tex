...
\pgmlItem{}(1pt)$P(Y=3|X=3) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}(1pt)$P(X=1|Y=1) = $ \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\pgmlItem{}(3 pts) Using Q function in your answer, what is the approximate probability of $P(S > 82)$\mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\item\begin{verbatim}(90-22)^2/(12*33)\end{verbatim}
\item\begin{verbatim}Q((82-(22+90)/2)/(sqrt{(90-22)^2/(12*33)}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vskip\baselineskip
(3 pts) Using Chebyshev's inequality, give an upper bound on $P(|Y| > 20)$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}0\end{verbatim}
...
\mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
(3 pts) What is the probability that the time gap between two packets is larger than 0.035? \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\vskip\baselineskip
...
\vspace{-\parskip}\begin{itemize}
\item  $50$
\item  $1-\sum_{i=0}^{200} \frac{50^i}{i!} e^{-50}$
\item  $3600*(1-\sum_{i=0}^{200} \frac{50^i}{i!} e^{-50})$
\item  $e^{-50*0.035}$
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
