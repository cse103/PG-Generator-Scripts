...
\item\begin{verbatim}(78-(-4))^2/(12*48)\end{verbatim}
\item\begin{verbatim}Q((70-(-4+78)/2)/(sqrt{(78--4)^2/(12*48)}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vspace{-\parskip}\begin{itemize}
\item  $200$
\item  $1-\sum_{i=0}^{200} \frac{200^i}{i!} e^{-200}$
\item  $3600*(1-\sum_{i=0}^{200} \frac{200^i}{i!} e^{-200})$
\item  $e^{-200*0.02}$
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
