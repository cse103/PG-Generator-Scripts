...
\noindent {\large \bf Ibrhaim Awwal}
\hfill
...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}(1pt)$P(Y=3|X=2) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
\pgmlRule{100\pgmlPercent}{1\pgmlPixels}%
...
{\pgmlSetup
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}(1pt)$P(Y=2|X=2) = $ \mbox{\parbox[t]{5ex}{\hrulefill}}
\pgmlRule{100\pgmlPercent}{1\pgmlPixels}%
...
\item\begin{verbatim}(16-3)*(5**5-5)\end{verbatim}
\item\begin{verbatim}(16-3)*(5**5-5)/C(80,5)\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\par}%
\leavevmode\\\relax 
\includegraphics[width=0.8\linewidth]{/opt/webwork/courses/CSE103_Fall14/templates/setCDF/mixture_cdf_19.png}
...
\vskip\baselineskip
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
\pgmlItem{}(3 pts) The exponential component has $\lambda$ of 0.5, the probability of the exponential component assigns to the segment $[0,1.5]$ is \mbox{\parbox[t]{5.5ex}{\hrulefill}}

\pgmlItem{}(3 pts) The weight of the exponential component is \mbox{\parbox[t]{5.5ex}{\hrulefill}}

\pgmlItem{}(2 pts) The weight corresponding to the uniform component is therefore \mbox{\parbox[t]{6.5ex}{\hrulefill}}

\pgmlItem{}(2 pts) The uniform component is over (\mbox{\parbox[t]{3ex}{\hrulefill}},\mbox{\parbox[t]{3ex}{\hrulefill}}).

\par}%
\par}%
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}1-e^{-0.5*1.5}\end{verbatim}
\item\begin{verbatim}5/1-e^{-0.5*1.5}\end{verbatim}
\item\begin{verbatim}1-5/1-e^{-0.5*1.5}\end{verbatim}
...
\vskip\baselineskip
Denote by $n$=196  the number passengers that have booked the flight and by $S=\sum_{i=1}^n X_i$ the number of passengers that arrived for the flight. 
\vskip\baselineskip
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
...
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}196*0.85\end{verbatim}
\item\begin{verbatim}sqrt (196 * 0.85 * (1 - 0.85))\end{verbatim}
\item\begin{verbatim}Q((180-(196*0.85))/(sqrt (196 * 0.85 * (1 - 0.85))))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}(38+98)/2\end{verbatim}
\item\begin{verbatim}(98-38)^2/12\end{verbatim}
\item\begin{verbatim}Q((90-(38+98)/2)/(sqrt{(98-38)^2/12}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}56*0.3*(1-0.3)\end{verbatim}
\item\begin{verbatim}56*0.3*(1 - 0.3)/26^2\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}1-e^(-100*0.025)\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
