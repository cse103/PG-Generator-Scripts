...
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}16-3\end{verbatim}
\item\begin{verbatim}4**5 - 4\end{verbatim}
\item\begin{verbatim}(16-3)*(4**5-4)\end{verbatim}
\item\begin{verbatim}(16-3)*(4**5-4)/C(64,5)\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}-1.5\end{verbatim}
\item\begin{verbatim}4.5\end{verbatim}
\item\begin{verbatim}(0-(-1.5))/(4.5-(-1.5))\end{verbatim}
\item\begin{verbatim}0.09/((0-(-1.5))/(4.5-(-1.5)))\end{verbatim}
\item\begin{verbatim}0.65\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vskip\baselineskip
Denote by $n$=223  the number passengers that have booked the flight and by $S=\sum_{i=1}^n X_i$ the number of passengers that arrived for the flight. 
\vskip\baselineskip
{\pgmlIndent\let\pgmlItem=\pgmlbulletItem
...
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}223*0.89\end{verbatim}
\item\begin{verbatim}sqrt (223 * 0.89 * (1 - 0.89))\end{verbatim}
\item\begin{verbatim}Q((210-(223*0.89))/(sqrt (223 * 0.89 * (1 - 0.89))))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}(18+98)/2\end{verbatim}
\item\begin{verbatim}(98-18)^2/12\end{verbatim}
\item\begin{verbatim}Q((90-(18+98)/2)/(sqrt{(98-18)^2/12}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}72*0.4*(1-0.4)\end{verbatim}
\item\begin{verbatim}72*0.4*(1 - 0.4)/23^2\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}0\end{verbatim}
\item\begin{verbatim}1-e^(-50*0.025)\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
