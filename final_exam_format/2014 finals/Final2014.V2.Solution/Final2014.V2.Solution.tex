...
\par}%
\leavevmode\\\relax 
\includegraphics[width=0.8\linewidth]{imgs/mixture_cdf_16.png}
...
\pgmlItem{}(3 pts) The probability that the uniform probability assigns to the segment $[-1.5, 0]$ is \mbox{  \parbox[t]{20ex}{\hrulefill}  }



\pgmlItem{}(3 pts) The weight of the uniform distribution is \mbox{  \parbox[t]{20ex}{\hrulefill}  }



\pgmlItem{}(2 pts) The weight of the exponential component is therefore \mbox{  \parbox[t]{20ex}{\hrulefill}  }
...
\item\begin{verbatim}0.09\end{verbatim}
\item\begin{verbatim}0.09/((0-(-1.5))/(4.5-(-1.5)))\end{verbatim}
\item\begin{verbatim}1-0.09/((0-(-1.5))/(4.5-(-1.5)))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\item\begin{verbatim}(98-18)^2/(12*30)\end{verbatim}
\item\begin{verbatim}Q((90-(18+98)/2)/(sqrt{(98-18)^2/(12*30)}))\end{verbatim}
\end{itemize}}\par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright � 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
...
\vskip\baselineskip
(3 pts) Using Chebyshev's inequality, give an upper bound on $P(|Y| > 23)$?  \mbox{  \parbox[t]{20ex}{\hrulefill}  }
\par}%
\par{\small{\it Correct Answers:}
\vspace{-\parskip}\begin{itemize}
\item\begin{verbatim}0\end{verbatim}
